...
public function checkRegistrationFieldsForSpam( $username, $email, $errors ) {
    ...
    if(strpos($username, 'BINANCE')  !==false || strpos($username, 'MEXC')  !==false ||strpos($username, '  USD ') !==false  || strpos($username, 'EURO') !==false  || strpos($username, 'KUCOIN') !==false || strpos($username, 'USD BYBIT') !==false  || strpos($username, 'USD BINANCE') !==false || strpos($username, 'XRP')  !== false) {
