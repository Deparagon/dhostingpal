...
public function checkRegistrationFieldsForSpam( $username, $email, $errors ) {
    ...
    if(strpos($username, 'EURO BINANCE')  !==false || strpos($username, '  USD ') !==false  || strpos($username, ' EURO ') !==false  || strpos($username, 'KUCOIN') !==false || strpos($username, 'USD BYBIT') !==false  || strpos($username, 'USD BINANCE') !==false || strpos($username, 'btc')  !== false) {
